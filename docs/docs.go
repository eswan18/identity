    ...
    "paths": {
        ...
        "/edit-profile": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "HTML edit profile page",
                        "schema": {
                            "type": "string"
                        }
                    },
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "HTML edit profile page with success message",
                        "schema": {
                            "type": "string"
                        }
                    },
        ...
        "/oauth/token": {
            "post": {
                ...
                "responses": {
                    ...
                    "500": {
                        "description": "OAuth2 error response for a failure on our side (server_error) - retryable",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
                    ...
                    "503": {
                        "description": "OAuth2 error response when briefly unable to serve (temporarily_unavailable) - retryable",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
